...
public:
    ...
    /// advance_previous_nav_cmd - moves previous nav command forward
    //      starting_index is used to set the index to which searching will reach, leave as 0 to search from the current navigation target
    void advance_previous_nav_cmd();
